...
const menuItems = [
  ...
  { label: "INVESTMENT BENEFITS", href: "#investment-benefits" },
...
const Header = () => {
  ...
  return (
    <>
      {/* Header */}
      <header className="w-full shadow-md fixed top-0 left-0 right-0 z-30 bg-[#E7EFD8] lg:bg-[#fff] py-4">
            ...
            {menuItems.map((item) =>
              item.children ? (
                ...
                >
                  ...
                  {/* Dropdown — pt-2 bridges the gap so onMouseLeave doesn't fire early */}
                  <div
